...
function SearchFlight() {
  ...
  const [tripType, setTripType] = useState("return"); // State for trip type
  ...
  return (
    <div className="d-flex flex-column min-vh-100">
      <div className="flex-grow-1 p-5">
        ...
        <div className="d-flex align-items-center mb-4 mt-4">
          <div className="me-3">
            <select
              ...
              value={tripType}
              onChange={(e) => setTripType(e.target.value)} // Update trip type based on selection
            >
        ...
        {showModal && (
          <div
            className="passenger-modal mt-3 p-4"
            style={{
