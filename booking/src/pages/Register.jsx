  ...
  <div class="container h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-lg-12 col-xl-11">
        <div class="card text-black shadow-lg rounded-4" >
              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                        <select>
                        <option value="" disabled selected class="form-control">Select Account</option>

                            <option value="simple_user">Simple User</option>
                            <option value="simple_user">Bussines</option>
                        </select>
                      <label class="form-label" for="form3Example1c">Select Account</label>
                    </div>
                  </div>
